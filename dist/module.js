...
System.register(['./components/config/config', './components/device/device_list', './components/device/device_details', './components/device/device_config', './components/alarm/alarm_config', './components/alarm/alarm_list', 'app/plugins/sdk', './filters/all', './directives/all'], function (_export, _context) {
  "use strict";

  var ConfigCtrl, DeviceListCtrl, DeviceDetailsCtrl, DeviceConfigCtrl, AlarmConfigCtrl, AlarmListCtrl, loadPluginCss;
  return {
